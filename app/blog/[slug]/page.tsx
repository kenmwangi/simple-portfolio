...
export default async function Blog({ params }: { params: any }) {
  ...
  return (
    <section className="mx-auto max-w-4xl px-6 md:px-12 mt-16">
      <ReportView slug={post.slug} />
      <div className="flex flex-row space-x-4 mb-6 text-sm">
        <Link
          href="/blog"
          className="group flex flex-row items-center space-x-1 bg-transparent"
        >
          <ArrowLeft
            size={18}
            className="group-hover:-translate-x-1 duration-300 group-hover:text-zinc-600"
          />
